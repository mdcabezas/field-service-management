...
func NewChecklistTemplateHandler(repo repository.ChecklistTemplateRepository) *ChecklistTemplateHandler {
	return &ChecklistTemplateHandler{repo: repo}
}

func (h *ChecklistTemplateHandler) GetByID(c *gin.Context) {
...
func (h *ChecklistTemplateHandler) List(c *gin.Context) {
...
func (h *ChecklistTemplateHandler) Create(c *gin.Context) {
	var item inventory.ChecklistTemplate
...
func (h *ChecklistTemplateHandler) Update(c *gin.Context) {
	id, ok := handler.ParseUUID(c, "id")
	if !ok {
		handler.RespondError(c, http.StatusBadRequest, "invalid id")
		return
...
func (h *ChecklistTemplateHandler) Delete(c *gin.Context) {
	id, ok := handler.ParseUUID(c, "id")
	if !ok {
		handler.RespondError(c, http.StatusBadRequest, "invalid id")
		return
