...
type VisitEPPUsageHandler struct {
	repo repository.VisitEPPUsageRepository
}

func NewVisitEPPUsageHandler(repo repository.VisitEPPUsageRepository) *VisitEPPUsageHandler {
	return &VisitEPPUsageHandler{repo: repo}
}

func (h *VisitEPPUsageHandler) GetByID(c *gin.Context) {
...
func (h *VisitEPPUsageHandler) ListByVisit(c *gin.Context) {
...
func (h *VisitEPPUsageHandler) Create(c *gin.Context) {
	var body operations.VisitEPPUsage
...
func (h *VisitEPPUsageHandler) Delete(c *gin.Context) {
	id, ok := handler.ParseUUID(c, "id")
	if !ok {
		handler.RespondError(c, http.StatusBadRequest, "invalid id")
		return
