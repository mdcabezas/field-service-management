...
type ChecklistTemplateEPPHandler struct {
	repo repository.ChecklistTemplateEPPRepository
}

func NewChecklistTemplateEPPHandler(repo repository.ChecklistTemplateEPPRepository) *ChecklistTemplateEPPHandler {
	return &ChecklistTemplateEPPHandler{repo: repo}
}

func (h *ChecklistTemplateEPPHandler) GetByID(c *gin.Context) {
...
func (h *ChecklistTemplateEPPHandler) ListByTemplate(c *gin.Context) {
...
func (h *ChecklistTemplateEPPHandler) Create(c *gin.Context) {
	var body operations.ChecklistTemplateEPP
...
func (h *ChecklistTemplateEPPHandler) Delete(c *gin.Context) {
	id, ok := handler.ParseUUID(c, "id")
	if !ok {
		handler.RespondError(c, http.StatusBadRequest, "invalid id")
		return
